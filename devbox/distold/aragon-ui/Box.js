...
var _StyledDiv = _styled__default['default']("div").withConfig({
  ...
  componentId: "kjg7wk-0"
})(["position:relative;border-style:solid;border-color:", ";border-width:", ";background:", ";color:", ";& + &{margin-top:", "px;}"], function (p) {
  return p._css;
}, function (p) {
  return p._css2;
}, function (p) {
...
var _StyledDiv2 = _styled__default['default']("div").withConfig({
  ...
  componentId: "kjg7wk-2"
})(["padding:", "px;background:", ";"], function (p) {
  return p._css11;
}, function (p) {
  return p._css12;
});
...
function Box(_ref) {
  var heading = _ref.heading,
      ...
      props = objectWithoutProperties.objectWithoutProperties(_ref, ["heading", "headingColor", "children", "padding"]);
  ...
  return /*#__PURE__*/React__default['default'].createElement(index.i, {
    ...
    _css: theme.border,
    _css2: headingColor ? '0px;' : fullWidth ? '1px 0' : '1px',
    _css3: headingColor ? headingColor : theme.surface,
...
Box.propTypes = {
  ...
  headingColor: index$1.propTypes.node,
