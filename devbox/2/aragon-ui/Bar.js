...
var _StyledDiv4 = _styled__default['default']("div").withConfig({
  ...
  componentId: "tgik7d-3"
})(["background:", ";border-style:solid;border-color:", ";border-width:", ";height:", "px;margin-bottom:", "px;"], function (p) {
  return p._css;
}, function (p) {
  return p._css2;
}, function (p) {
...
function Bar(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(index.i, {
    ...
    _css: theme.surface,
    _css2: theme.border,
    _css3: fullScreen ? '1px 0' : '1px',
    _css4: 8 * constants.GU,
